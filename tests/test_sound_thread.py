...
from janitoo_raspberry_sound.thread_sound import SoundThread

class TestSoundThread(JNTTThreadRun, JNTTThreadRunCommon):
    """Test the thread
    """
    thread_name = "rpisound"
    conf_file = "tests/data/janitoo_raspberry_sound.conf"
